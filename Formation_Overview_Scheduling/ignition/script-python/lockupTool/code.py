...
LINE_NAME_1 = constants.LINE_NAME_1
LINE_NAME_2 = constants.LINE_NAME_2
LINE_MIN_TABLE_1 = constants.LINE_MIN_TABLE_1
LINE_MAX_TABLE_1 = constants.LINE_MAX_TABLE_1
LINE_MIN_TABLE_2 = constants.LINE_MIN_TABLE_2
LINE_MAX_TABLE_2 = constants.LINE_MAX_TABLE_2
DATA_PATH = constants.DATA_PATH
InitConst1 = constants.InitConst1
InitConst2 = constants.InitConst2
CALC_FOLDER = constants.CALC_FOLDER
EMPTY_STATES = constants.EMPTY_STATES
...
def getTableData(tagPath):
	...
	if str(state) in emptyStates or tagValues[0].quality == "Bad":
		isEmpty = True
