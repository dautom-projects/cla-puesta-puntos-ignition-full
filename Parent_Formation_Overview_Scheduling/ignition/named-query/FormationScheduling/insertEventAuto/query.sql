...
insert into currentSchedule ( tstamp , StatusID ,  ItemID , StartDate , EndDate , Label,  DUFWRev, [Group], FormProg , FormHrs ,  RefillAcid,  BathLevel,  Priority ,  [Table], Qty,
	 TableAlias1 , DateSched , Shift , InRoom , ProdOrder , LegacyNumber , Pos , GpoDoof, Batch , StartOrder, TruckNotes, TruckOrder, TruckOrderIndex )
values (
	getdate(),
	2,
	:table ,
	...
	:table,
	:qty,
	 :eastWest , :date , :shift , :inRoom , :prodOrder , :legacy , :pos , :gpoDoof , :batch,:startOrder, :truckNotes, :truckOrder, :truckOrderIndex
